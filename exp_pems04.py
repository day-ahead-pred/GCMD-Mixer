...
import torch
from get_adj import get_adj_pems04


parser = argparse.ArgumentParser(description="GCMDMixer")

parser.add_argument("--config", type=str, default="pems04.yaml")
...
name = "./save/pems04/pems04_" + current_time + "/"
...
if args.modelfolder == "":
    ...
    model.load_state_dict(torch.load("./save/pems04/" + args.modelfolder + "/model.pth"))
